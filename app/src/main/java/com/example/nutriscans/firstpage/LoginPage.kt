...
fun LoginPage(navController: NavController) {
    ...
    Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
        ScrollableColumn(emailValue, passwordValue, passwordVisibility, navController = navController)
    }
}
...
fun ScrollableColumn(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            placeholder = { Text(text = "Enter Your Username/Email") },
        ...
        Row{
            ...
            Text(
                modifier = Modifier.clickable(onClick = {
                    navController.navigate(route = NavScreen.Register.route)
                }),
                fontWeight = FontWeight.Bold,
                color = Color.Cyan,
                fontSize = 12.sp,
